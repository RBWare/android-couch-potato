 ...
 * {@link com.rbware.github.androidcouchpotato.widget.ObjectAdapter}. It is similar to Adapter and the
 * RecyclerView Adapter, but separates iterating items from presenting them as Views.
 * Concrete implementations include
 * {@link com.rbware.github.androidcouchpotato.widget.ArrayObjectAdapter} and
 * {@link com.rbware.github.androidcouchpotato.widget.CursorObjectAdapter}, but a developer is free to use a
 * subclass of an ObjectAdapter to iterate over any existing Object hierarchy.
 * </p>
 * <p>
 * A {@link com.rbware.github.androidcouchpotato.widget.Presenter} creates Views and binds data from an Object
 ...
 * </p>
 * A {@link com.rbware.github.androidcouchpotato.widget.PresenterSelector} determines which Presenter to use
 ...
 * ({@link com.rbware.github.androidcouchpotato.widget.SinglePresenterSelector}), and when the Presenter is
 * determined by the Java class of
 * the element ({@link com.rbware.github.androidcouchpotato.widget.ClassPresenterSelector}).  A developer is
 ...
 * {@link com.rbware.github.androidcouchpotato.widget.Row}, which defines the
 * abstract concept of a row with a header; and {@link com.rbware.github.androidcouchpotato.widget.ListRow},
 ...
 * {@link com.rbware.github.androidcouchpotato.widget.ListRowPresenter}.
 * </p>
 * <p>
 * Other types of Rows and corresponding RowPresenters are provided; however the application may
 * define a custom subclass of {@link com.rbware.github.androidcouchpotato.widget.Row} and
 * {@link com.rbware.github.androidcouchpotato.widget.RowPresenter}.
 * </p>
 */
