 ...
 */
public final class EmptyListRowView extends LinearLayout {

    private HorizontalGridView mGridView;

    private TextView mEmptyTextView;

    public EmptyListRowView(Context context) {
        this(context, null);
    }

    public EmptyListRowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyListRowView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        LayoutInflater inflater = LayoutInflater.from(context);
        inflater.inflate(R.layout.lb_empty_list_row, this);
    ...
    public TextView getEmptyTextView() { return mEmptyTextView; }
